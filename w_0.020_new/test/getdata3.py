...
if __name__=='__main__':
    p_arr=np.arange(0.01,0.2,0.02)#[0.003,0.0044,0.001008,0.0072,0.0086,0.01,0.0114,0.0128,0.0142,0.011006,0.0170,0.0184,0.0198,0.0212,0.0226,0.0240,0.021004,0.0268,0.0282,0.0296]
